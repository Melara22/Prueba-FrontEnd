    ...
    <div class="container">
      <div class="row">
        <div class="about-header">
            ...
            <h2 class="wow fadeIn">La unica forma de hacer un gran trabajo,<br> es amar lo que haces</h2>
  ...
  <section class="about-post">
    <div class="container">
        <div class="row"> 
            ...
            <div class="col-md post-text">
              <h5>2015 year</h5>
                  <h1 class="wow fadeInUp" data-wow-duration="2s">For those about to rock</h1>
                  <br>
                  <div class="line-separator"></div>
                  <br>
                  <p class="wow fadeInUp" data-wow-duration="2s">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
        ...
        <div class="row post"> 
          <div class="col-md d-block d-sm-none">
  ...
  <section class="parallax-body">    
    <div class="text-parallax">
     ...
     <footer class="footer">
      <div class="container">
        <div class="row">
            <div class="col-md wow fadeInUp" data-wow-duration="2s">
              <h5>Office</h5>
